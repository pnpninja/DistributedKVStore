...
func (cfg *config) checkOneLeader() int {
	node0Term ,node0isLeader := cfg.rafts[0].GetState()
	node1Term,node1isLeader := cfg.rafts[1].GetState()
	node2Term,node2isLeader := cfg.rafts[2].GetState()
	DPrintf("Node0 isLeader - %+v\n",node0isLeader)
	DPrintf("Node0 term - %+v\n",node0Term)
	DPrintf("Node1 isLeader - %+v\n",node1isLeader)
	DPrintf("Node1 term - %+v\n",node1Term)
	DPrintf("Node2 isLeader - %+v\n",node2isLeader)
	DPrintf("Node2 term - %+v\n",node2Term)
